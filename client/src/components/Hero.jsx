...
const Hero = () => {
  return (
    <div
      ...
      aria-label="Hero section featuring the ultimate hotel experience"
    >
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20">
        The Ultimate Hotel Experience
      </p>
      <h1 className="font-playfair text-2xl md:text-5xl lg:text-7xl xl:text-6xl font-bold md:font-extrabold max-w-xl mt-4">
      ...
      <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-5 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                <div className='flex items-center gap-2'>
                   <img src={assets.calenderIcon} alt="" className='w-4 h-4' />
